...
**Our call for proposals is open until Sunday the 15th June, 2025.**
...
The PyCon AU call for proposals (CFP) is open from May 23, 2025 until the end of **Sunday the 15th of June, 2025**, anywhere on earth. You can submit to the main conference and specialist tracks through the same process.
