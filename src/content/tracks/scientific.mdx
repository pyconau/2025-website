...
This year, PyCon AU is partnering with the Journal of Open Source Software (JOSS) to publish academic papers in association with PyCon AU submissions. If you are interested, see [here](/program/#new-academic-abstract-submission) for more information.
