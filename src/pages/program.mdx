...
The PyCon AU call for proposals (CFP) is open until the end of **Monday 15 May**, anywhere on earth. There is a countdown on the portal if you get lost navigating timezones. You can submit to the main conference and specialist tracks through the same process.

_(Note: In most channels, the CFP was originally advertised as closing Sunday 14 May. However, in our mailing list we erroneously advertised it as closing on Monday 15th. Because of this, the CFP has been extended by one day in order to not disadvantage anybody who relied on that email.)_
