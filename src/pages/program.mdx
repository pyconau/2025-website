...
The PyCon AU call for proposals (CFP) is open until **TODO ENTER DATE**, anywhere on earth. There is a countdown on the portal if you get lost navigating timezones. You can submit to the main conference and specialist tracks through the same process.
