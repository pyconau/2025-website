...
In order to support speakers, we will offer mentorship and feedback to those who would like it. You can request mentorship by contacting [program@pycon.org.au](mailto:program@pycon.org.au) and we’ll put you in touch with a mentor as soon as we can.
